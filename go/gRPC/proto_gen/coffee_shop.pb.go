...
const file_coffee_shop_proto_rawDesc = "" +
	"\n" +
	"\x11coffee_shop.proto\x12\x04gRPC\"\r\n" +
	"\vMenuRequest\")\n" +
	"\x05Order\x12 \n" +
	"\x05items\x18\x01 \x03(\v2\n" +
	".gRPC.ItemR\x05items\"\x19\n" +
	"\aReceipt\x12\x0e\n" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\x9c\x01\n" +
	"\n" +
	"CoffeeShop\x12,\n" +
	"\aGetMenu\x12\x11.gRPC.MenuRequest\x1a\n" +
	".gRPC.Menu\"\x000\x01\x12*\n" +
	"\n" +
	"PlaceOrder\x12\v.gRPC.Order\x1a\r.gRPC.Receipt\"\x00\x124\n" +
	"\x0eGetOrderStatus\x12\r.gRPC.Receipt\x1a\x11.gRPC.OrderStatus\"\x00B#Z!github.com/ChanukaUOJ/gotuto/gRPCb\x06proto3"
...
var file_coffee_shop_proto_goTypes = []any{
	(*MenuRequest)(nil), // 0: gRPC.MenuRequest
	(*Order)(nil),       // 1: gRPC.Order
	(*Receipt)(nil),     // 2: gRPC.Receipt
	(*OrderStatus)(nil), // 3: gRPC.OrderStatus
	(*Menu)(nil),        // 4: gRPC.Menu
	(*Item)(nil),        // 5: gRPC.Item
}
var file_coffee_shop_proto_depIdxs = []int32{
	5, // 0: gRPC.Order.items:type_name -> gRPC.Item
	5, // 1: gRPC.Menu.items:type_name -> gRPC.Item
	0, // 2: gRPC.CoffeeShop.GetMenu:input_type -> gRPC.MenuRequest
	1, // 3: gRPC.CoffeeShop.PlaceOrder:input_type -> gRPC.Order
	2, // 4: gRPC.CoffeeShop.GetOrderStatus:input_type -> gRPC.Receipt
	4, // 5: gRPC.CoffeeShop.GetMenu:output_type -> gRPC.Menu
	2, // 6: gRPC.CoffeeShop.PlaceOrder:output_type -> gRPC.Receipt
	3, // 7: gRPC.CoffeeShop.GetOrderStatus:output_type -> gRPC.OrderStatus
